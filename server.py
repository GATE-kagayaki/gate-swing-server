...
4. 【手順】は、単なる無機質な動作マニュアルにならないよう注意してください。「どこに力を入れるか」「どんな感覚になれば正解か」といった『プロならではの具体的なコツや身体の感覚』を必ず交えて記述すること。熱量のあるコーチングスタイルを保ちつつ、練習場でスマホを見ながら実践しやすい文字数に収めてください。
...
[
  {{
    "name": "ドリルの名前",
    "purpose": "● 短く分かりやすい目的1\\n● 短く分かりやすい目的2",
    "how": "① 【構え・準備】具体的なアクションと意識するポイント\\n② 【動作・スイング】どんな感覚になれば正解かというプロのコツ\\n③ 【回数・確認】最後にチェックするポイントや目安の回数"
  }},
  {{
    ...
  }}
