...
from typing import Any, Dict, List, Optional # NameError 対策済み
...
import cv2 # import位置を修正 (analyze_swing_with_mediapipe内で再importする必要がなくなる)
import mediapipe as mp # import位置を修正
...
def analyze_swing_with_mediapipe(video_path: str) -> Dict[str, Any]:
    ...
    with mp_pose.Pose(
        ...
        while cap.isOpened():
            ...
            frame_count += 1
            # 🚨 エラー処理を強化: MediaPipe処理中のクラッシュをスキップ
            try:
